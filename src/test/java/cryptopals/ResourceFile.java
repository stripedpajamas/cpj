...
public class ResourceFile extends ExternalResource {
  ...
  public String getContent(String charSet) throws IOException {
    final InputStreamReader reader = new InputStreamReader(createInputStream(), Charset.forName(charSet));
  ...
  private void createFile() throws IOException {
    file = new File(".", res);
    final InputStream stream = getClass().getResourceAsStream(res);
    try {
      file.createNewFile();
